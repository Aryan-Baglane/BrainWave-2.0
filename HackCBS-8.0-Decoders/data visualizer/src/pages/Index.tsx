...
import { Brain, Upload, BarChart3, MessageCircle, TrendingUp, Sparkles, Zap, X, Database } from "lucide-react"
import {
  ResponsiveContainer,
  LineChart,
  Line,
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 max-w-2xl mx-auto">
            ...
            <TabsTrigger value="mongodb-agent" onClick={() => window.location.href = 'http://localhost:5173'} className="flex items-center gap-2">
